...
// my component
////////////////////////// Drivers --- start ////////////
const ApprovalPendingDrivers = lazy(() =>
  import("./views/apps/driver/ApprovalPendingDrivers")
);
const Create = lazy(() => import("./views/apps/driver/Create"));
const ApprovedDrivers = lazy(() =>
  import("./views/apps/driver/ApprovedDrivers")
);
const DriverRatings = lazy(() => import("./views/apps/driver/DriverRatings"));
const NegativeBalanceDrivers = lazy(() =>
  import("./views/apps/driver/NegativeBalanceDrivers")
);
const WithdrawalRequests = lazy(() =>
  import("./views/apps/driver/WithdrawalRequests")
);
const VehicleTypes = lazy(() => import("./views/apps/vehicle/VehicleTypes"));

const VehicleModel = lazy(() => import("./views/apps/vehicle/VehicleModel"));
const AddVehicleModel = lazy(() =>
  import("./views/apps/vehicle/AddVehicleModel")
);
      ...
      <Router history={history}>
        <HashRouter>
          <Switch>
            ...
            {/* Driver-start */}
            <AppRoute
              path="/app/driver/approvalPendingDrivers"
              component={ApprovalPendingDrivers}
            />
            <AppRoute path="/app/driver/create" component={Create} />
            <AppRoute
              path="/app/driver/approvedDrivers"
              component={ApprovedDrivers}
            />
            <AppRoute
              path="/app/driver/driverRatings"
              component={DriverRatings}
            />
            <AppRoute
              path="/app/driver/negativeBalanceDrivers"
              component={NegativeBalanceDrivers}
            />
            <AppRoute
            ...
            />
            <AppRoute
              path="/app/vehicle/vehicleTypes"
              component={VehicleTypes}
            />
            <AppRoute
              path="/app/vehicle/vehicleModel"
              component={VehicleModel}
            />
            <AppRoute
              path="/app/vehicle/addVehicleModel"
            ...
            />
            <AppRoute
              path="/app/userride/editUserRide"
              component={EditUserRide}
            />
            <AppRoute
              path="/app/userride/viewUserRide"
